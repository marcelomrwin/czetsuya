jboss7-seam3-security: Example Using Multiple Java EE 6 Technologies Deployed as an EAR
=====================
Author: Pete Muir
Level: Intermediate
Technologies: EAR
...
4. This will deploy `target/jboss7-seam3-security.ear` to the running instance of the server.


Access the application 
---------------------

The application will be running at the following URL <http://localhost:8080/jboss7-seam3-security/>.
